...
const SingerPage: React.FC = () => {
  ...
  return (
    <Container size="md" className="py-6 space-y-6">
      ...
      <div className="text-center">
        <div className="flex justify-center mb-4">
          <div className="p-4 bg-blue-100 dark:bg-blue-900/30 rounded-full">
            <MicrophoneIcon className="h-12 w-12 text-blue-600 dark:text-blue-400" />
          </div>
        </div>
      ...
      {/* Your Queue Status */}
      {hasActiveRequest && (
        <Card variant="elevated" className="border-2 border-yellow-300 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-900/20">
          <CardContent>
            <div className="text-center">
            ...
            <div className="space-y-2">
              {queue.slice(0, 5).map((entry, index) => (
                ...
                >
                  ...
                  {index === 0 && (
                    <span className="text-xs font-medium text-yellow-600 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-900/50 px-2 py-1 rounded">
                      Up Next
                    </span>
                  )}
                </div>
